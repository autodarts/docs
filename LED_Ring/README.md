...
-   option moertek mc920:
    - [3x modular_webcam_moertek.stl](https://github.com/autodarts/docs/blob/main/LED_Ring/stl/modular_webcam_moertek.stl)
    - [3x modular_webcam_moertek_lid.stl](https://github.com/autodarts/docs/blob/main/LED_Ring/stl/modular_webcam_moertek_lid.stl) 
